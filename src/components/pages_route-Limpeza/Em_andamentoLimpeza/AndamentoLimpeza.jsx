    ...
    <>
      <HeadGlob>
        <ul className='flex justify-center items-center gap-10'>
          <li ><Link to="/Limpeza" className=' text-[1.2rem] hover:text-[#FFF607]'>Solicitação de Limpeza</Link></li>
          <li ><Link to="../Limpeza/Todos-os-pedidos" className=' text-[1.2rem] hover:text-[#FFF607]'>Todas as Solicitações</Link></li>
          <li ><Link to="../Limpeza/pedidos-concluido" className=' text-[1.2rem] hover:text-[#FFF607]'>Concluidos</Link></li>
          <li ><Link to="../Limpeza/emandamento" className=' text-[1.2rem] hover:text-[#FFF607]'>Em Andamento</Link></li>
          <LogOut />
        </ul>
      </HeadGlob>
